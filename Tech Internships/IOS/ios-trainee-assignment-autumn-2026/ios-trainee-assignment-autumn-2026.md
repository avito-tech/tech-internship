...
1. Разместите исходный код в публичном репозитории.
2. Добавьте файл `README.md`, где при необходимости добавьте инструкции по сборке/запуску приложения,
отразите ключевые решения, принятые в ходе реализации, и то, **почему** они именно такие.
3. Добавьте файл `AI_USAGE.md`.
