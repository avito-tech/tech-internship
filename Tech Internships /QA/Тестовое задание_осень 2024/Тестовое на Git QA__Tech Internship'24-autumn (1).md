...
## **Задание 2**
Вам доступно два варианта выполнения задания. Выберите **только один** из них - так можно сделать более качественное и полное решение.

## Вариант 1 

### Суть задания
Составьте тест кейсы для проверки api этого микросервиса. Автоматизируйте написанные тест кейсы, где необходимо проверить результат (Все тесты должны быть пройдены)
...
- [Postman коллекция](https://github.com/avito-tech/tech-internship/blob/main/Tech%20Internships%20/QA/%D0%A2%D0%B5%D1%81%D1%82%D0%BE%D0%B2%D0%BE%D0%B5%20%D0%B7%D0%B0%D0%B4%D0%B0%D0%BD%D0%B8%D0%B5_%D0%BE%D1%81%D0%B5%D0%BD%D1%8C%202024/Postman-API.postman_collection.json)
